# -*- coding: utf-8 -*-
"""
Created on Mon Jun  4 19:22:53 2018

@author: Sunil Angadi
"""

""" WELCOME note in a mat """
...
you have the bottom by reversing it. 
...
line 3: put things together. '\n'.join() should be straightforward.
 Then, the sequence of strings to join is the pattern described above,
 the middle 'WELCOME' line, and the pattern reversed."""



n, m = map(int,input().split()) # m should be multiple of n
