''' Reading input in matrix form
arr1 = [[j for j in input().split()] for i in range(n)]
print(arr1)'''
...
#taking input from user
    ...
    array1=[[int(x) for x in input().split()]for i in range(m)]

    print ("enter second matrix elements:")
    array2=[[int(x) for x in input().split()]for i in range(p)]
